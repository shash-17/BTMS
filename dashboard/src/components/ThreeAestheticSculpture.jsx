...
export default function ThreeAestheticSculpture() {
  ...
  return (
    <div style={{ position: "relative", width: "100%", height: "100%" }}>
      ...
      {/* Top Left Aesthetic Presets HUD */}
      <div
        style={{
          position: "absolute",
          top: "14px",
      ...
      >
        <button
          onClick={() => handleSwitchForm("gyro")}
          style={{
            background: activeForm === "gyro" ? "#fff" : "rgba(10,10,10,0.8)",
            color: activeForm === "gyro" ? "#000" : "#aaa",
        ...
        <button
          onClick={() => handleSwitchForm("torus")}
          style={{
            background: activeForm === "torus" ? "#fff" : "rgba(10,10,10,0.8)",
            color: activeForm === "torus" ? "#000" : "#aaa",
            border: "1px solid #333",
            padding: "4px 10px",
            fontSize: "11px",
            fontWeight: "700",
        ...
        <button
          onClick={() => handleSwitchForm("geodesic")}
          style={{
            background: activeForm === "geodesic" ? "#fff" : "rgba(10,10,10,0.8)",
            color: activeForm === "geodesic" ? "#000" : "#aaa",
            border: "1px solid #333",
            padding: "4px 10px",
            fontSize: "11px",
            fontWeight: "700",
      ...
      >
        <button
          onClick={() => setSpeedMultiplier(speedMultiplier === 1 ? 2.5 : 1)}
          style={{
            background: "rgba(10,10,10,0.85)",
            color: speedMultiplier > 1 ? "#fff" : "#888",
            border: speedMultiplier > 1 ? "1px solid #fff" : "1px solid #444",
            padding: "4px 10px",
            fontSize: "11px",
            borderRadius: "4px",
            fontWeight: "700",
        ...
        >
          {speedMultiplier > 1 ? "SPEED: 2.5X" : "SPEED: 1.0X"}
        </button>

        <button
          onClick={() => setWireframeOnly(!wireframeOnly)}
          style={{
            background: wireframeOnly ? "rgba(255,255,255,0.2)" : "rgba(10,10,10,0.85)",
            color: wireframeOnly ? "#fff" : "#888",
        ...
        >
          {wireframeOnly ? "WIREFRAME: ON" : "SHADED"}
        </button>
      </div>

      {/* Bottom Aesthetic HUD Overlay */}
      <div
        style={{
          position: "absolute",
          bottom: "14px",
      ...
      >
        ...
        <div style={{ color: "#777", fontSize: "11px" }}>
          Cursor Parallax • Drag to Rotate
        </div>
      </div>
    </div>
  );
